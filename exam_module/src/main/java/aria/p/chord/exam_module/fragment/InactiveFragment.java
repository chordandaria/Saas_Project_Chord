...
public class InactiveFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter=new ExamListRecAdapter(viewModule.getInactiveData().getValue(),getContext());
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModule.getInactiveData().observe(this, new Observer<ArrayList<ExamListDataBean>>() {
            @Override
