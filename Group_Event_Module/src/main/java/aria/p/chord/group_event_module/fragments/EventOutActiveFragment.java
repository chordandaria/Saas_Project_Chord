...
public class EventOutActiveFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter=new EventListAdapter(viewModule.getEventOutActive().getValue(),getContext());
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModule.getEventOutActive().observe(this, new Observer<ArrayList<EventListDataBean>>() {
            @Override
    ...
    public void refreshList(){
        currentPage=1;
        viewModule.requestEventInactive(currentPage,true);
    }
    ...
    public void loadList(){
        ...
        if (currentPage>totalPage){
            ...
            viewModule.requestEventInactive(currentPage,false);
        }
    }
}
