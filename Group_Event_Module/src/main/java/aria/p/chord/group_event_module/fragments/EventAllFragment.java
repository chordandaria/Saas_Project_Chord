...
public class EventAllFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter=new EventListAdapter(viewModule.getEventAll().getValue(),getContext());
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewModule.getEventAll().observe(this, new Observer<ArrayList<EventListDataBean>>() {
            @Override
    ...
    public void refreshList(){
        currentPage=1;
        viewModule.requestEventList(currentPage,true);
    }
    ...
    public void loadList(){
        ...
        if (currentPage>totalPage){
            ...
            viewModule.requestEventList(currentPage,false);
        }
    }
